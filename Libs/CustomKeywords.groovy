...
def static "FinalKeywords.convertRGBAStringToHex"(
    	String colorRGB	) {
    (new FinalKeywords()).convertRGBAStringToHex(
        	colorRGB)
}


def static "FinalKeywords.convertRGBStringToHex"(
    	String colorRGB	) {
    (new FinalKeywords()).convertRGBStringToHex(
        	colorRGB)
}


def static "FinalKeywords.getRGBString"(
    	String str	) {
    (new FinalKeywords()).getRGBString(
        	str)
}


def static "FinalKeywords.getTextFromList"(
    	TestObject obj	) {
    (new FinalKeywords()).getTextFromList(
        	obj)
}


def static "FinalKeywords.getTextOfElement"(
    	TestObject obj	) {
    (new FinalKeywords()).getTextOfElement(
        	obj)
}
